...
from twister_harness.twister_harness_config import TwisterExtConfig
...
def pytest_addoption(parser: pytest.Parser):
    twister_harness_group = parser.getgroup('Twister ext')
...
def pytest_configure(config: pytest.Config):
    ...
    config.twister_harness_config = TwisterExtConfig.create(config)  # type: ignore
